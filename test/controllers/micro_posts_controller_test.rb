...
class MicroPostsControllerTest < ActionController::TestCase
  ...
  test "should create micro_post" do
    assert_difference('MicroPost.count') do
      post :create, micro_post: { content: @micro_post.content, id: @micro_post.id, user: @micro_post.user }
    end
  ...
  test "should update micro_post" do
    patch :update, id: @micro_post, micro_post: { content: @micro_post.content, id: @micro_post.id, user: @micro_post.user }
    assert_redirected_to micro_post_path(assigns(:micro_post))
  end
